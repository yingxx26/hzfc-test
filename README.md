...
<mapper namespace="com.hzfc.management.wyzj.modules.ums.mapper.UmsMenuMapper">

    <select id="getMenuList" resultType="com.hzfc.management.wyzj.modules.ums.model.UmsMenu">
        SELECT
            m.id id,
