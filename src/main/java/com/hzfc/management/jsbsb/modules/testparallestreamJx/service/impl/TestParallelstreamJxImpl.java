package com.hzfc.management.jsbsb.modules.testparallestreamJx.service.impl;
 ...
 */
@Service
public class TestParallelstreamJxImpl implements TestParallelstreamJxService {
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        // List<ZhThjxDto> zhThjxDtos = new ArrayList<ZhThjxDto>();
        List<ZhThjxDto> zhThjxDtos = wxjZjlistList.parallelStream().map(x -> {
            ZhThjxDto zhThjxDto = m2(tprJxjg, thisDay, lastlastDayOfYear, lastDayOfYearDate, dayOfYearDate, x);
            //zhThjxDtos.add(zhThjxDto);
            return zhThjxDto;
...
//		计算并打印耗时
    ...
    public ZhThjxDto m2(TprJxjg tprJxjg, LocalDate thisDay, LocalDate lastlastDayOfYear, Date lastDayOfYearDate, Date dayOfYearDate, List<TprJxzhzjbd> array) {

        ZhThjxDto zhThjxDtos = mainFunction(tprJxjg, thisDay, lastlastDayOfYear, lastDayOfYearDate, dayOfYearDate, array);
    ...
    private ZhThjxDto mainFunction(TprJxjg tprJxjg, LocalDate thisDay, LocalDate lastlastDayOfYear, Date lastDayOfYearDate, Date dayOfYearDate, List<TprJxzhzjbd> wxjZjlistList) {


        List<TprDqjxgs> dqgslist = new ArrayList();
        List<TprHqjxgs> hqgslist = new ArrayList();
        //维修金 重要逻辑
        List<TprJxzhzjbd> tprJxzhzjbdList = wxjZjlistList;
