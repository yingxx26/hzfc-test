...
import com.hzfc.management.jsbsb.modules.ums.po.UmsResourcePo;
import com.hzfc.management.jsbsb.modules.ums.service.UmsResourceService;
import com.hzfc.management.jsbsb.security.component.DynamicSecurityMetadataSource;
...
public class UmsResourceController {
    ...
    @ResponseBody
    public CommonResult create(@RequestBody UmsResourcePo umsResourcePo) {
        UmsResource umsResource = new UmsResource();
        BeanUtils.copyProperties(umsResourcePo, umsResource);
    ...
    public CommonResult update(@PathVariable Long id,
                               @RequestBody UmsResourcePo umsResourcePo) {
        UmsResource umsResource = new UmsResource();
        BeanUtils.copyProperties(umsResourcePo, umsResource);
