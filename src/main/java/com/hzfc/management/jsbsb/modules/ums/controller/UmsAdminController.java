...
import com.hzfc.management.jsbsb.modules.ums.dto.UmsAdminLoginParam;
...
import com.hzfc.management.jsbsb.modules.ums.po.UmsAdminPo;
...
public class UmsAdminController {
    ...
    @ResponseBody
    public CommonResult update(@PathVariable Long id, @RequestBody UmsAdminPo adminPo) {
        UmsAdmin umsAdmin = new UmsAdmin();
        BeanUtils.copyProperties(adminPo, umsAdmin);
