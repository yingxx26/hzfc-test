...
public class RedisConfig {
    ...
    @Bean
    @ConditionalOnClass(RedisConnectionFactory.class)
    public MyRedisCache redisCache(RedisTemplate redisTemplate) {
        return new MyRedisCache(redisTemplate);
    }

    @Bean
    @ConditionalOnClass(RedissonClient.class)
    public MyRedisLock redisLock(RedissonClient redissonClient) {
        return new MyRedisLock(redissonClient);
    }
}
