...
public class ExportWordController {
    ...
    @Autowired
    private ZhiBiaoGyXmService zhiBiaoGyXmService;
    ...
    private void spfcj(Map<String, Object> dataFinal, LocalDate thisDay, ExportDataPackage exportDataPackage) {
        ...
        ///////商品房预售-全市-住宅
        //图标数据-批准套数
        List<ZhiBiaoSpfPzYs> pzys_taoshu_everyMonth_zz_list = zhiBiaoSpfPzYsCqList.stream().filter(x -> x.getTjsj().compareTo(firstMonth_yyyyMM_thisyear) >= 0 && "批准预售套数-住宅".equals(x.getZbname())).sorted(Comparator.comparing(ZhiBiaoSpfPzYs::getTjsj)).distinct().collect(Collectors.toList());
        ...
        //本月供销比 pzys_gongXiaoBi_zz_list最后一个
        exportDataPackage.setPzys_gongXiaoBi_zz_list(pzys_gongXiaoBi_zz_list);
        dataFinal.put("gxb", pzys_gongXiaoBi_zz_list.get(pzys_gongXiaoBi_zz_list.size() - 1));
...
/////////////////////商品房中非住宅////////////////////////////////
        ...
        //////////////////////均价-非住宅/////////////////////////////
        //成交均价-全市
        Double spfcj_jj_thisMonth_fzz = new BigDecimal(spfcj_jinE_thisMonth_fzz / spfcj_mianJi_thisMonth_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        dataFinal.put("spfcj_jj_thisMonth_fzz", spfcj_jj_thisMonth_fzz);
        //成交均价同比-全市
        Double spfcj_jj_thisMonth_lastyear_fzz = new BigDecimal(spfcj_jinE_thisMonth_lastyear_fzz / spfcj_mianJi_thisMonth_lastyear_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        ...
        //成交金额环比-全市
        Double spfcj_jj_lastMonth_fzz = new BigDecimal(spfcj_jinE_lastMonth_fzz / spfcj_mianJi_lastMonth_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        ...
        //成交均价-市区
        Double spfcj_jj_thisMonth_shiqu_fzz = new BigDecimal(spfcj_jinE_thisMonth_shiqu_fzz / spfcj_mianJi_thisMonth_shiqu_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        dataFinal.put("spfcj_jj_thisMonth_shiqu_fzz", spfcj_jj_thisMonth_shiqu_fzz);
        //成交均价tong比-市区
        Double spfcj_jj_thisMonth_lastyear_shiqu_fzz = new BigDecimal(spfcj_jinE_thisMonth_lastyear_shiqu_fzz / spfcj_mianJi_thisMonth_lastyear_shiqu_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        ...
        //成交均价环比-市区
        Double spfcj_jj_lastMonth_shiqu_fzz = new BigDecimal(spfcj_jinE_lastMonth_shiqu_fzz / spfcj_mianJi_lastMonth_shiqu_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        ...
        //全年均价——今年
        Double spfcj_sum_jj_everyMonth_fzz = new BigDecimal(spfcj_sum_jinE_everyMonth_fzz / spfcj_sum_mianJi_everyMonth_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        dataFinal.put("spfcj_sum_jj_everyMonth_fzz", spfcj_sum_jj_everyMonth_fzz);
        Double spfcj_sum_jj_everyMonth_lastyear_fzz = new BigDecimal(spfcj_sum_jinE_everyMonth_lastyear_fzz / spfcj_sum_mianJi_everyMonth_lastyear_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        //成交均价同比-全年度
        ...
        //全年均价——今年-市区
        Double spfcj_sum_jj_everyMonth_shiqu_fzz = new BigDecimal(spfcj_sum_jinE_everyMonth_shiqu_fzz / spfcj_sum_mianJi_everyMonth_shiqu_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        dataFinal.put("spfcj_sum_jj_everyMonth_shiqu_fzz", spfcj_sum_jj_everyMonth_shiqu_fzz);
        Double spfcj_sum_jj_everyMonth_shiqu_lastyear_fzz = new BigDecimal(spfcj_sum_jinE_everyMonth_lastyear_shiqu_fzz / spfcj_sum_mianJi_everyMonth_lastyear_shiqu_fzz).multiply(new BigDecimal(10000)).setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
...
/////////批准可售-非住宅
        List<ZhiBiaoSpfPzks> pzks_mianJi_everyMonth_thisyear_list = zhiBiaoSpfPzksCqList.stream().filter(x -> x.getTjsj().compareTo(firstMonth_yyyyMM_thisyear) >= 0 && "批准可售面积-非住宅".equals(x.getZbname())).distinct().sorted(Comparator.comparing(ZhiBiaoSpfPzks::getTjsj)).collect(Collectors.toList());
        ...
        //去年
        QueryWrapper<ZhiBiaoSpfPzks> wrapper25 = new QueryWrapper<>();
        LambdaQueryWrapper<ZhiBiaoSpfPzks> lambda25 = wrapper25.lambda();
        lambda25.ge(ZhiBiaoSpfPzks::getTjsj, firstMonth_yyyyMM_lastyear);
        lambda25.le(ZhiBiaoSpfPzks::getTjsj, thisMonth_yyyyMM_lastyear);
        List<ZhiBiaoSpfPzks> zhiBiaoSpfPzksCqList_lastyear = zhiBiaoSpfPzksService.list(wrapper25);

        //可售套数-上年-这个月
        ZhiBiaoSpfPzks pzks_taoshu_thisMonth_lastYear_fzz = zhiBiaoSpfPzksCqList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "批准可售套数-非住宅".equals(x.getZbname())).findFirst().get();
        //可售面积-上年-这个月
        ZhiBiaoSpfPzks pzks_mianJi_thisMonth_lastYear_fzz = zhiBiaoSpfPzksCqList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "批准可售面积-非住宅".equals(x.getZbname())).findFirst().get();

        //可售套数同比
        BigDecimal pzks_tb_taoshu_thisMonth_fzz = new BigDecimal((float) ((pzks_taoshu_thisMonth_fzz.getSpfPzksZbzTmAll() - pzks_taoshu_thisMonth_lastYear_fzz.getSpfPzksZbzTmAll()) / pzks_taoshu_thisMonth_lastYear_fzz.getSpfPzksZbzTmAll()));
        dataFinal.put("pzks_tb_taoshu_thisMonth_fzz", pzks_tb_taoshu_thisMonth_fzz.multiply(new BigDecimal("100")).setScale(1, BigDecimal.ROUND_HALF_UP) + "%");
        //可售面积同比
        BigDecimal pzks_tb_mianJi_thisMonth_fzz = new BigDecimal((float) ((pzks_mianJi_thisMonth_fzz.getSpfPzksZbzTmAll() - pzks_mianJi_thisMonth_lastYear_fzz.getSpfPzksZbzTmAll()) / pzks_mianJi_thisMonth_lastYear_fzz.getSpfPzksZbzTmAll()));
        dataFinal.put("pzks_tb_mianJi_thisMonth_fzz", pzks_tb_mianJi_thisMonth_fzz.multiply(new BigDecimal("100")).setScale(1, BigDecimal.ROUND_HALF_UP) + "%");
...
///////////////////////二手房////////////////////////
        ...
        //成交面积-全市-当月
        ZhiBiaoEsfJy esf_mj_thisMonth = zhiBiaoEsfJyList.stream().filter(x -> thisMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月面积".equals(x.getZbname())).findFirst().get();
        dataFinal.put("esf_mj_thisMonth", NumUtils.DoubleFormat(esf_mj_thisMonth.getEsfjyZbzZzCntTm(), 1));
        //成交金额-全市-当月
        ...
        dataFinal.put("esf_jj_thisMonth", NumUtils.DoubleFormat(esf_jj_thisMonth.getEsfjyZbzZzCntTm(), 1));

        //当年
        //成交套数 -全市-当年
        Double esf_taoshu_everyMonth = esf_taoshu_thisMonth.getEsfjyZbzZzCntTy();
        dataFinal.put("esf_taoshu_everyMonth", esf_taoshu_everyMonth.intValue());
        //成交面积-全市-当年
        Double esf_mj_everyMonth = esf_mj_thisMonth.getEsfjyZbzZzCntTy();
        dataFinal.put("esf_mj_everyMonth", esf_mj_everyMonth.intValue());
        //成交均价-全市-当年
        Double esf_jj_everyMonth = esf_jj_thisMonth.getEsfjyZbzZzCntTy();
        dataFinal.put("esf_jj_everyMonth", esf_jj_everyMonth.intValue());

        //去年
        QueryWrapper<ZhiBiaoEsfJy> wrapper14 = new QueryWrapper<>();
        LambdaQueryWrapper<ZhiBiaoEsfJy> lambda14 = wrapper14.lambda();
        lambda14.ge(ZhiBiaoEsfJy::getTjsj, firstMonth_yyyyMM_lastyear);
        lambda14.le(ZhiBiaoEsfJy::getTjsj, thisMonth_yyyyMM_lastyear);
        List<ZhiBiaoEsfJy> zhiBiaoEsfJyList_lastyear = zhiBiaoEsfJyService.list(wrapper14);

        ZhiBiaoEsfJy esf_taoshu_thisMonth_lastyear = zhiBiaoEsfJyList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "本月套数".equals(x.getZbname())).findFirst().get();
        ZhiBiaoEsfJy esf_mj_thisMonth_lastyear = zhiBiaoEsfJyList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "本月面积".equals(x.getZbname())).findFirst().get();
        ZhiBiaoEsfJy esf_jj_thisMonth_lastyear = zhiBiaoEsfJyList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "本月均价".equals(x.getZbname())).findFirst().get();

        //成交套数 -全市-去年
        Double esf_taoshu_everyMonth_lastyear = esf_taoshu_thisMonth_lastyear.getEsfjyZbzZzCntTy();
        //成交面积-全市-去年
        Double esf_mj_everyMonth_lastyear = esf_mj_thisMonth_lastyear.getEsfjyZbzZzCntTy();
        //成交均价-全市-去年
        ...
        //成交套数同比-全市-当年
        Double esf_tb_mj_everyMonth = (esf_mj_everyMonth - esf_mj_everyMonth_lastyear) / esf_mj_everyMonth_lastyear;
        dataFinal.put("esf_tb_mj_everyMonth", NumUtils.DoubleFormat(esf_tb_mj_everyMonth, 1) + "%");
        //成交均价同比-全市-当年
        Double esf_tb_jj_everyMonth = (esf_jj_everyMonth - esf_jj_everyMonth_lastyear) / esf_jj_everyMonth_lastyear;
        dataFinal.put("esf_tb_jj_everyMonth", NumUtils.DoubleFormat(esf_tb_jj_everyMonth, 1) + "%");


        ////////////////////////二手房---市区成交//////////////////////////////////
        QueryWrapper<ZhiBiaoEsfJyShiQu> wrapper15 = new QueryWrapper<>();
        LambdaQueryWrapper<ZhiBiaoEsfJyShiQu> lambda15 = wrapper15.lambda();
        lambda15.ge(ZhiBiaoEsfJyShiQu::getTjsj, firstMonth_yyyyMM_thisyear);
        lambda15.le(ZhiBiaoEsfJyShiQu::getTjsj, thisMonth_yyyyMM_thisyear);
        List<ZhiBiaoEsfJyShiQu> zhiBiaoEsfJyShiQuList = zhiBiaoEsfJyShiQuService.list(wrapper15);

        //成交套数-shiqu-当月
        ZhiBiaoEsfJyShiQu esf_taoshu_thisMonth_shiqu = zhiBiaoEsfJyShiQuList.stream().filter(x -> thisMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月套数".equals(x.getZbname())).findFirst().get();
        dataFinal.put("esf_taoshu_thisMonth_shiqu", esf_taoshu_thisMonth_shiqu.getEsfjyZbzZzCntTm().intValue());
        //成交面积-shiqu-当月
        ZhiBiaoEsfJyShiQu esf_mj_thisMonth_shiqu = zhiBiaoEsfJyShiQuList.stream().filter(x -> thisMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月面积".equals(x.getZbname())).findFirst().get();
        dataFinal.put("esf_mj_thisMonth_shiqu", NumUtils.DoubleFormat(esf_mj_thisMonth_shiqu.getEsfjyZbzZzCntTm(), 1));
        //成交金额-shiqu-当月
        ZhiBiaoEsfJyShiQu esf_jj_thisMonth_shiqu = zhiBiaoEsfJyShiQuList.stream().filter(x -> thisMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月均价".equals(x.getZbname())).findFirst().get();
        dataFinal.put("esf_jj_thisMonth_shiqu", NumUtils.DoubleFormat(esf_jj_thisMonth_shiqu.getEsfjyZbzZzCntTm(), 1));

        //成交套数同比-shiqu-当月
        dataFinal.put("esf_tb_taoshu_thisMonth_shiqu", NumUtils.DoubleFormat(esf_taoshu_thisMonth_shiqu.getEsfjyZbzZzCntTyTb(), 1) + "%");
        //成交套数同比-shiqu 当月
        dataFinal.put("esf_tb_mj_thisMonth_shiqu", NumUtils.DoubleFormat(esf_mj_thisMonth_shiqu.getEsfjyZbzZzCntTyTb(), 1) + "%");
        //成交均价同比-shiqu-当月
        dataFinal.put("esf_tb_jj_thisMonth_shiqu", NumUtils.DoubleFormat(esf_jj_thisMonth_shiqu.getEsfjyZbzZzCntTyTb(), 1) + "%");

        //成交套数-shiqu-上月
        ZhiBiaoEsfJyShiQu esf_taoshu_lastMonth_shiqu = zhiBiaoEsfJyShiQuList.stream().filter(x -> lastMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月套数".equals(x.getZbname())).findFirst().get();

        //成交面积-shiqu-上月
        ZhiBiaoEsfJyShiQu esf_mj_lastMonth_shiqu = zhiBiaoEsfJyShiQuList.stream().filter(x -> lastMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月面积".equals(x.getZbname())).findFirst().get();
        esf_mj_lastMonth_shiqu.getEsfjyZbzZzCntTm();
        //成交金额-shiqu-上月
        ZhiBiaoEsfJyShiQu esf_jj_lastMonth_shiqu = zhiBiaoEsfJyShiQuList.stream().filter(x -> lastMonth_yyyyMM_thisyear.equals(x.getTjsj()) && "本月均价".equals(x.getZbname())).findFirst().get();
        esf_jj_lastMonth_shiqu.getEsfjyZbzZzCntTm();

        //成交套数环比-shiqu-当月
        Double esf_hb_taoshu_thisMonth_shiqu = (esf_taoshu_thisMonth_shiqu.getEsfjyZbzZzCntTm() - esf_taoshu_lastMonth_shiqu.getEsfjyZbzZzCntTm()) / esf_taoshu_lastMonth_shiqu.getEsfjyZbzZzCntTm();
        dataFinal.put("esf_hb_taoshu_thisMonth_shiqu", NumUtils.DoubleFormat(esf_hb_taoshu_thisMonth_shiqu, 1) + "%");
        //成交套数环比-shiqu 当月
        Double esf_hb_mj_thisMonth_shiqu = (esf_mj_lastMonth_shiqu.getEsfjyZbzZzCntTm() - esf_mj_lastMonth_shiqu.getEsfjyZbzZzCntTm()) / esf_mj_lastMonth_shiqu.getEsfjyZbzZzCntTm();
        dataFinal.put("esf_hb_mj_thisMonth_shiqu", NumUtils.DoubleFormat(esf_hb_mj_thisMonth_shiqu, 1) + "%");
        //成交均价环比-shiqu-当月
        Double esf_hb_jj_thisMonth_shiqu = (esf_jj_lastMonth_shiqu.getEsfjyZbzZzCntTm() - esf_jj_lastMonth_shiqu.getEsfjyZbzZzCntTm()) / esf_jj_lastMonth_shiqu.getEsfjyZbzZzCntTm();
        dataFinal.put("esf_hb_jj_thisMonth_shiqu", NumUtils.DoubleFormat(esf_hb_jj_thisMonth_shiqu, 1) + "%");


        //当年
        //成交套数 -全市-当年
        Double esf_taoshu_everyMonth_thisYear_shiqu = esf_taoshu_thisMonth_shiqu.getEsfjyZbzZzCntTy();
        dataFinal.put("esf_taoshu_everyMonth_thisYear_shiqu", esf_taoshu_everyMonth_thisYear_shiqu.intValue());
        //成交面积-全市-当年
        Double esf_mj_everyMonth_thisYear_shiqu = esf_mj_thisMonth_shiqu.getEsfjyZbzZzCntTy();
        dataFinal.put("esf_mj_everyMonth_thisYear_shiqu", esf_mj_everyMonth_thisYear_shiqu.intValue());
        //成交均价-全市-当年
        Double esf_jj_everyMonth_thisYear_shiqu = esf_jj_thisMonth_shiqu.getEsfjyZbzZzCntTy();
        dataFinal.put("esf_jj_everyMonth_thisYear_shiqu", esf_jj_everyMonth_thisYear_shiqu.intValue());

        //去年
        QueryWrapper<ZhiBiaoEsfJyShiQu> wrapper16 = new QueryWrapper<>();
        LambdaQueryWrapper<ZhiBiaoEsfJyShiQu> lambda16 = wrapper16.lambda();
        lambda16.ge(ZhiBiaoEsfJyShiQu::getTjsj, firstMonth_yyyyMM_lastyear);
        lambda16.le(ZhiBiaoEsfJyShiQu::getTjsj, thisMonth_yyyyMM_lastyear);
        List<ZhiBiaoEsfJyShiQu> zhiBiaoEsfJyShiQuList_lastyear = zhiBiaoEsfJyShiQuService.list(wrapper16);

        ZhiBiaoEsfJyShiQu esf_taoshu_thisMonth_lastyear_shiqu = zhiBiaoEsfJyShiQuList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "本月套数".equals(x.getZbname())).findFirst().get();
        ZhiBiaoEsfJyShiQu esf_mj_thisMonth_lastyear_shiqu = zhiBiaoEsfJyShiQuList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "本月面积".equals(x.getZbname())).findFirst().get();
        ZhiBiaoEsfJyShiQu esf_jj_thisMonth_lastyear_shiqu = zhiBiaoEsfJyShiQuList_lastyear.stream().filter(x -> thisMonth_yyyyMM_lastyear.equals(x.getTjsj()) && "本月均价".equals(x.getZbname())).findFirst().get();

        //成交套数 -shiqu-去年
        Double esf_taoshu_everyMonth_lastyear_shiqu = esf_taoshu_thisMonth_lastyear_shiqu.getEsfjyZbzZzCntTy();
        //成交面积 -shiqu-去年
        Double esf_mj_everyMonth_lastyear_shiqu = esf_mj_thisMonth_lastyear_shiqu.getEsfjyZbzZzCntTy();
        //成交均价 -shiqu-去年
        Double esf_jj_everyMonth_lastyear_shiqu = esf_jj_thisMonth_lastyear_shiqu.getEsfjyZbzZzCntTy();

        //成交套数同比-shiqu-当年
        Double esf_tb_taoshu_everyMonth_shiqu = (esf_taoshu_everyMonth_thisYear_shiqu - esf_taoshu_everyMonth_lastyear_shiqu) / esf_taoshu_everyMonth_lastyear_shiqu;
        dataFinal.put("esf_tb_taoshu_everyMonth_shiqu", NumUtils.DoubleFormat(esf_tb_taoshu_everyMonth_shiqu, 1) + "%");
        //成交套数同比-shiqu-当年
        Double esf_tb_mj_everyMonth_shiqu = (esf_mj_everyMonth_thisYear_shiqu - esf_mj_everyMonth_lastyear_shiqu) / esf_mj_everyMonth_lastyear_shiqu;
        dataFinal.put("esf_tb_mj_everyMonth_shiqu", NumUtils.DoubleFormat(esf_tb_mj_everyMonth_shiqu, 1) + "%");
        //成交均价同比-shiqu-当年
        Double esf_tb_jj_everyMonth_shiqu = (esf_jj_everyMonth_thisYear_shiqu - esf_jj_everyMonth_lastyear_shiqu) / esf_jj_everyMonth_lastyear_shiqu;
    ...
    private void spfxqcj(Map<String, Object> dataFinal, LocalDate thisDay) {
        ...
        List<String> allXqXm = new ArrayList<String>();
        for (Map.Entry<String, Long> entry : spf_zz_ts_xq_thismonth_collect_sorted.entrySet()) {
            ...
            allXqXm.add(entry.getKey());
        }
        Map.Entry<String, Long> firstXq = spf_zz_ts_xq_thismonth_collect_sorted_finalmap.get(1);
        String firstXqXm = firstXq.getKey();
        dataFinal.put("firstXqXm", firstXqXm + "");
        Long firstXqTs = firstXq.getValue();
        dataFinal.put("firstXqTs", firstXqTs + "");
        ...
        dataFinal.put("firstXqDistrict", firstXqDistrict + "");
        List<String> top10XqXm = allXqXm.subList(0, 9);
        List<Map<String, String>> top10XqXmList = new ArrayList<Map<String, String>>();
        for (int i = 0; i < top10XqXm.size(); i++) {
            String aString = top10XqXm.get(i);
            Map<String, String> map = new HashMap<String, String>();
            if (i == 0) {
                map.put("top10XqXmData", aString);
            } else {
                map.put("top10XqXmData", "、" + aString);
            }
            top10XqXmList.add(map);
        }

        dataFinal.put("top10XqXmList", top10XqXmList);
        System.out.println();
    }
    ...
    private void spfCqGy(Map<String, Object> dataFinal, LocalDate thisDay) {
        ...
        Map<String, LongSummaryStatistics> spf_zz_ts_cq_thismonth = Optional.ofNullable(zhiBiaoGyDwDxxCqDfList).get().stream().distinct().filter(x -> !StringUtils.isEmpty(x.getCqmc()) && !"市区".equals(x.getCqmc()) && !"主城区".equals(x.getCqmc()) && !"大杭州".equals(x.getCqmc()) && "住宅".equals(x.getFwyt())).collect(Collectors.groupingBy(ZhiBiaoGyDwDxxCqDf::getCqmc, Collectors.summarizingLong(ZhiBiaoGyDwDxxCqDf::getGyTsCntTmCqid)));
        ...
        dataFinal.put("firstCqXm", firstCqXm);
        Long firstCqTs = firstCq.getValue();
        dataFinal.put("firstCqTs", firstCqTs);
        ZhiBiaoGyDwDxxCqDf zhiBiaoGyDwDxxCqDf = zhiBiaoGyDwDxxCqDfList.stream().filter(x -> firstCqXm.equals(x.getCqmc())).findFirst().get();
        Double firstCqMj = zhiBiaoGyDwDxxCqDf.getGyMjAmtTmCqid();
        dataFinal.put("firstCqMj", firstCqMj);

        Map.Entry<String, Long> secondCq = spf_zz_ts_cq_thismonth_collect_sorted_finalmap.get(2);
        String secondCqXm = secondCq.getKey();
        dataFinal.put("secondCqXm", secondCqXm);
        Map.Entry<String, Long> thirdCq = spf_zz_ts_cq_thismonth_collect_sorted_finalmap.get(3);
        String thirdCqXm = thirdCq.getKey();
        dataFinal.put("thirdCqXm", thirdCqXm);

        String thisMonth_yyyyMM_thisyear = DateUtil.format(thisMonthFirstdayDate, "yyyyMM");
        Gyxm gyxm = zhiBiaoGyXmService.getGyxmList(thisMonth_yyyyMM_thisyear);
        String lpmc = gyxm.getLpmc();
        Long fwcount = gyxm.getFwcount();
        dataFinal.put("lpmc", lpmc);
        dataFinal.put("fwcount", fwcount);
    ...
    private void clfGuaPai(Map<String, Object> dataFinal, LocalDate thisDay, ExportDataPackage exportDataPackage) {
        ...
        if (esfgp_wcj_taoshu_thisMonth.getEsfGpZbzTmAll() == null) {
            return;
        }
        Double v = esfgp_wcj_taoshu_thisMonth.getEsfGpZbzTmAll() / 10000;
        dataFinal.put("esfgp_wcj_taoshu_thisMonth", v.intValue());
        ...
        Double vv = esfgp_zz_wcj_taoshu_thisMonth.getEsfGpZbzTmSq() / 10000;
        dataFinal.put("esfgp_zz_wcj_taoshu_thisMonth", vv.intValue());
        ...
        //套数环比
        if (esfgp_wcj_taoshu_lastMonth.getEsfGpZbzTmAll() != null) {
    ...
    private void yhbm(Map<String, Object> dataFinal, LocalDate last, ExportDataPackage exportDataPackage) {
        ...
        //当年总报名人数 去重
        Long yhbm_zbmsize_distinct = sourceListThis.stream().filter(x -> x.getBmrs() != null).distinct().mapToLong(ZhiBiaoYhbm::getBmrs).sum();
        dataFinal.put("yhbm_zbmsize_distinct", yhbm_zbmsize_distinct.intValue());
        //当年总无房人数 去重
        Long yhbm_wfsize = sourceListThis.stream().filter(x -> x.getWfbmrs() != null).distinct().mapToLong(ZhiBiaoYhbm::getWfbmrs).sum();
        dataFinal.put("yhbm_wfsize", yhbm_wfsize.intValue());
        //当年无房占比
        BigDecimal yhbm_wfzb = new BigDecimal((float) yhbm_wfsize / yhbm_zbmsize_distinct).multiply(new BigDecimal("100")).setScale(1, BigDecimal.ROUND_HALF_UP);
        dataFinal.put("yhbm_wfzb", yhbm_wfzb + "%");

        //当年总无房人数 去重
        Long yhbm_rcsize = sourceListThis.stream().filter(x -> x.getRcbmrs() != null).distinct().mapToLong(ZhiBiaoYhbm::getRcbmrs).sum();
        dataFinal.put("yhbm_rcsize", yhbm_rcsize.intValue());
        //当年无房占比
        BigDecimal yhbm_rczb = new BigDecimal((float) yhbm_rcsize / yhbm_zbmsize_distinct).multiply(new BigDecimal("100")).setScale(1, BigDecimal.ROUND_HALF_UP);
        dataFinal.put("yhbm_rczb", yhbm_rczb + "%");
    }
    ...
    private Map<String, Object> dealChart_Cj(LocalDate last, Map<String, Object> paramMap, ExportDataPackage exportDataPackage) {
        ...
        List<Double> pzys_taoshu_zz_list = exportDataPackage.getPzys_taoshu_zz_list();
        ...
        if (CollectionUtils.isEmpty(spfcj_taoshu_zz_list) || CollectionUtils.isEmpty(spfcj_jj_zz_thisyear_list)
                ...
                || CollectionUtils.isEmpty(pzys_taoshu_zz_list)
        ...
        seriesRenderData51.setValues(pzys_taoshu_zz_list.toArray(new Double[pzys_taoshu_zz_list.size()]));
