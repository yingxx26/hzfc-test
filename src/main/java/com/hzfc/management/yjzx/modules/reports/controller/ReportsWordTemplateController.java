...
public class ReportsWordTemplateController {
    ...
    @ApiOperation("根据用途或模板名分页获取模板分页列表")
    @RequestMapping(value = "/list", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<CommonPage<ReportsWordTemplate>> pagelist(@RequestParam(value = "keyword", required = false) String keyword,
    ...
    @ApiOperation("根据分类id获取模板列表")
    @RequestMapping(value = "/list/{categoryid}", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<List<ReportsWordTemplate>> listByCategory(@PathVariable Long categoryid) {
        List<ReportsWordTemplate> reportsWordTemplateList = reportsWordTemplateService.listByCategory(categoryid);
        return CommonResult.success(reportsWordTemplateList);
    }
