...
@TableName("HZ_TEST.DWS_YBTJ_ESFJY_SHIQU")
@ApiModel(value = "DWS_YBTJ_ESFJY_SHIQU指标", description = "二手房综合成交指标_市区")
public class ZhiBiaoEsfJyShiQu implements Serializable {
